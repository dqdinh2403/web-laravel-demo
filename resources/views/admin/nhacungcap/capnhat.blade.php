	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatNhaCungCap" name="formCapNhatNhaCungCap" method="POST" action="admin/nhacungcap/capnhat/{{$nhacungcap->ncc_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenNhaCungCap"> Tên nhà cung cấp(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenNhaCungCap" id="txtTenNhaCungCap" class="col-xs-10 col-sm-5" placeholder="Tên nhà cung cấp" value="{{$nhacungcap->ncc_ten}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtEmail" id="txtEmail" class="col-xs-10 col-sm-5" placeholder="Email" value="{{$nhacungcap->ncc_email}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtDiaChi" id="txtDiaChi" class="col-xs-10 col-sm-5" placeholder="Địa chỉ" value="{{$nhacungcap->ncc_diachi}}" />
						</div>
					</div>
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtDienThoai" id="txtDienThoai" class="col-xs-10 col-sm-5" placeholder="Điện thoại" value="{{$nhacungcap->ncc_dienthoai}}" />
						</div>
					</div>
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/nhacungcap/danhsach'" >
