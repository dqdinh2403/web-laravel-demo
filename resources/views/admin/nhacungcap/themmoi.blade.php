	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiNhaCungCap" name="formThemMoiNhaCungCap" method="POST" action="admin/nhacungcap/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenNhaCungCap"> Tên nhà cung cấp(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenNhaCungCap" id="txtTenNhaCungCap" class="col-xs-10 col-sm-5" placeholder="Tên nhà cung cấp" value="{{old('txtTenNhaCungCap')}}" />
						</div>
					</div>
