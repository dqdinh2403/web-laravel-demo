...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa nhà cung cấp '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="20%" class="center">Địa chỉ</th>
								<th width="10%" class="center">Điện thoại</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$ncc->ncc_diachi}}</td>
								<td class="left">{{$ncc->ncc_dienthoai}}</td>
								<td class="left">{{$ncc->ncc_email}}</td>
								<td class="center">
									<a class="green" href="admin/nhacungcap/capnhat/{{$ncc->ncc_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/nhacungcap/xoa/{{$ncc->ncc_ma}}" onclick="return deleteConfirm('{{$ncc->ncc_ten}}')">
