	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatCongViec" name="formCapNhatCongViec" method="POST" action="admin/congviec/capnhat/{{$congviec->cv_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenCongViec"> Tên công việc(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenCongViec" id="txtTenCongViec" class="col-xs-10 col-sm-5" placeholder="Tên công việc" value="{{$congviec->cv_ten}}" />
						</div>
					</div>
					...
					<div class="form-group">   
	                    ...
	                    <div class="col-sm-8">
	                    	<div class="wysiwyg-editor" id="editor1">{!!$congviec->cv_mota!!}</div>
	                    </div>
	                </div>
					...
					<div class="col-md-offset-2 col-md-10">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/congviec/danhsach'" >
