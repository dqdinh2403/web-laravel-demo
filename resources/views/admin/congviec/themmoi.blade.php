	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiCongViec" name="formThemMoiCongViec" method="POST" action="admin/congviec/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenCongViec"> Tên công việc(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenCongViec" id="txtTenCongViec" class="col-xs-10 col-sm-5" placeholder="Tên công việc" value="{{old('txtTenCongViec')}}" />
						</div>
					</div>
