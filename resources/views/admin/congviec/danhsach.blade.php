...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa công việc '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$cv->cv_ten}}</td>
								<td class="center">
								<a class="green" href="admin/congviec/capnhat/{{$cv->cv_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/congviec/xoa/{{$cv->cv_ma}}" onclick="return deleteConfirm('{{$cv->cv_ten}}')">
