...
@section('breadcrumb')
	...
	<li class="active">Danh sách sự kiện chưa duyệt</li>
@endsection

@section('content')
	<div class="page-content">
		<div class="page-header">
			<h1>Danh sách sự kiện chưa duyệt:</h1>
		</div><!-- /.page-header -->
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="25%" class="center">Sự kiện</th>
								<th width="10%" class="center">Ngày tổ chức</th>
								<th width="15%" class="center">Khách hàng</th>
								<th width="10%" class="center">Trạng thái</th>
								<th width="15%" class="center">Tùy chọn</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="center">{{date_format(date_create($sk->sk_thoigianbatdaud),'d/m/Y')}}</td>
								...
								<td class="center">
								@if($sk->sk_trangthai==1)
									<a class="green" href="admin/sukien/duyet/{{$sk->sk_ma}}">
								...
								@elseif($sk->sk_trangthai==2)
									(Không có hành động)
								@else
									<a class="blue" href="admin/sukien/taohopdong/{{$sk->sk_ma}}">
