	...
	<script type="text/javascript">
		function check(){
			...
			if(!(tungay=='' || denngay=='')){
				...
				document.getElementById('btnIn').setAttribute('disabled','');
			}
		}
		...
		function printBC(){
			...
			var link = 'admin/sukien/xuatbaocao/' + tungay + '/' + denngay;
...
@section('breadcrumb')
	...
	<li class="active">Thống kê sự kiện</li>
@endsection
	...
	<div class="page-content" >
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThongKeSuKien" name="formThongKeSuKien" method="POST" action="admin/sukien/thongke" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTuNgay"> Từ ngày(*): </label>
						<div class="col-sm-9">
				            <input type="date" name="txtTuNgay" id="txtTuNgay" class="col-xs-10 col-sm-5" placeholder="Từ ngày" 
				            	@if(isset($tungay))
				            		{{"value=".$tungay}}
				            	@endif
				            onchange="check()" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
				            <input type="date" name="txtDenNgay" id="txtDenNgay" class="col-xs-10 col-sm-5" placeholder="Đến ngày" 
				            	@if(isset($denngay))
				            		{{"value=".$denngay}}
				            	@endif
				            onchange="check()" />
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnIn" id="btnIn" onclick="printBC()" disabled="" >
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="15%" class="center">Loại sự kiện</th>
								<th width="30%" class="center">Sự kiện</th>
								<th width="20%" class="center">Địa điểm</th>
								<th width="15%" class="center">Thời gian</th>
								<th width="10%" class="center">Kinh phí</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$sk->lsk_ten}}</td>
								<td class="left">{{$sk->sk_ten}}</td>
								<td class="left">{{$sk->sk_diadiem}}</td>
								<td class="center">
									{{date_format(date_create($sk->sk_thoigianbatdaud),'d/m/Y')}}
								</td>
								<td style="text-align: right">{{number_format($sk->sk_kinhphi,0,',','.')}} VNĐ</td>
							</tr>
							<?php $stt++; ?>
							@endforeach
						</tbody>
