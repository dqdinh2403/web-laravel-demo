...
@section('title')
	{{"Quản lý nhân viên (lịch sử phụ trách)"}}
@endsection
...
@section('breadcrumb')
	...
	<li class="active">Lịch sử phụ trách công việc sự kiện</li>
@endsection

@section('content')
	<div class="page-content">
		<div class="page-header">
			<h1>Lịch sử phụ trách công việc sự kiện của nhân viên "{{$nhanvien->nv_tennhanvien}}":</h1>
		</div><!-- /.page-header -->
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="15%" class="center">Địa điểm</th>
								<th width="15%" class="center">Thời gian</th>
								<th width="15%" class="center">Công việc</th>
								<th width="15%" class="center">Số lượng nhân viên</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$sk->cv_ten}}</td>
								<td style="text-align: right">{{$sk->sk_cv_nv_soluongnhanvien}}</td>
								<td class="center">
									@if($sk->sk_cv_nv_trangthai==0)
