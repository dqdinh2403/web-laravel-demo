...
@section('breadcrumb')
	...
	<li class="active">Duyệt mượn</li>
@endsection

@section('content')
	<div class="page-content">
		<div class="page-header">
			<h1>Duyệt mượn dụng cụ</h1>
		</div><!-- /.page-header -->
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formDuyetMuon" name="formDuyetMuon" method="POST" action="admin/dungcu/duyetmuon/{{$sukien->sk_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

				    <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtSuKien"> Sự kiện(*): </label>
						<div class="col-sm-9">
				    ...
				    <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="slNhanVienMuon"> Nhân viên mượn(*): </label>
						<div class="col-sm-9">
							<select class="col-xs-10 col-sm-5" name="slNhanVienMuon" id="slNhanVienMuon">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtNgayMuon"> Ngày mượn(*): </label>
						<div class="col-sm-9">
				            <input type="date" name="txtNgayMuon" id="txtNgayMuon" class="col-xs-10 col-sm-5" value="{{old('txtNgayMuon')}}"/>
				        </div>
					</div>
						...
						<table class="table table-bordered table-hover dataTable" id="TableDungCu">
				            <thead>
				                <tr>
				                    ...
				                    <th style="width:50%; text-align:center">Dụng cụ</th>
				                    <th style="width:30%; text-align:center">Số lượng mượn</th>               
				                </tr>
				            </thead>
