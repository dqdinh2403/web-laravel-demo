	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatDungCu" name="formCapNhatDungCu" method="POST" action="admin/dungcu/capnhat/{{$dungcu->dc_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenDungCu"> Tên dụng cụ(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenDungCu" id="txtTenDungCu" class="col-xs-10 col-sm-5" placeholder="Tên dụng cụ" value="{{$dungcu->dc_ten}}" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtSoLuongConLai"> Số lượng còn lại(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtSoLuongConLai" id="txtSoLuongConLai" class="col-xs-10 col-sm-5" placeholder="Số lượng còn lại" value="{{$dungcu->dc_soluongconlai}}" disabled="" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtSoLuongTong"> Số lượng tổng(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtSoLuongTong" id="txtSoLuongTong" class="col-xs-10 col-sm-5" placeholder="Số lượng tổng" value="{{$dungcu->dc_soluongtong}}" disabled="" />
						</div>
					</div>
					...
					<div class="form-group">   
	                    ...
	                    <div class="col-sm-8">
	                    	<div class="wysiwyg-editor" id="editor1">{!!$dungcu->dc_mota!!}</div>
	                    </div>
	                </div>

	                <input type="hidden" name="txtMoTa" id="txtMoTa" value="">
					...
					<div class="col-md-offset-2 col-md-10">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/dungcu/danhsach'" >
