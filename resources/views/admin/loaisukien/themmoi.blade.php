	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiLoaiSuKien" name="formThemMoiLoaiSuKien" method="POST" action="admin/loaisukien/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenLoaiSuKien"> Tên loại sự kiện(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenLoaiSuKien" id="txtTenLoaiSuKien" class="col-xs-10 col-sm-5" placeholder="Tên loại sự kiện" value="{{old('txtTenLoaiSuKien')}}" />
						</div>
					</div>
