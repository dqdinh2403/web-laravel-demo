...
@section('breadcrumb')
	<li class="active">Quản lý loại sự kiện</li>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatLoaiSuKien" name="formCapNhatLoaiSuKien" method="POST" action="admin/loaisukien/capnhat/{{$loaisukien->lsk_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenLoaiSuKien"> Tên loại sự kiện(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenLoaiSuKien" id="txtTenLoaiSuKien" class="col-xs-10 col-sm-5" placeholder="Tên loại sự kiện" value="{{$loaisukien->lsk_ten}}" />
						</div>
					</div>
					...
					<div class="form-group">   
	                    ...
	                    <div class="col-sm-8">
	                    	<div class="wysiwyg-editor" id="editor1">{!!$loaisukien->lsk_mota!!}</div>
	                    </div>
	                </div>
					...
					<div class="col-md-offset-2 col-md-10">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/loaisukien/danhsach'" >
