...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa loại sự kiện '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
			...
			<div class="col-xs-12">
				...
				<div>
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th width="20%" class="center">STT</th>
								<th width="40%" class="center">Loại sự kiện</th>
								<th width="20%" class="center">Cập nhật</th>
								<th width="20%" class="center">Xóa</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$lsk->lsk_ten}}</td>
								<td class="center">
								<a class="green" href="admin/loaisukien/capnhat/{{$lsk->lsk_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/loaisukien/xoa/{{$lsk->lsk_ma}}" onclick="return deleteConfirm('{{$lsk->lsk_ten}}')">
