...
@section('title')
	{{"Quản lý quyền hệ thống (thêm mới)"}}
@endsection
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiQuyen" name="formThemMoiQuyen" method="POST" action="admin/quyen/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenQuyen"> Tên quyền hệ thống(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenQuyen" id="txtTenQuyen" class="col-xs-10 col-sm-5" placeholder="Tên quyền hệ thống" value="{{old('txtTenQuyen')}}" />
						</div>
					</div>
