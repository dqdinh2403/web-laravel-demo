...
@section('title')
	{{"Quản lý quyền hệ thống (phân quyền)"}}
@endsection
...
@section('breadcrumb')
	<li class="active">Quản lý quyền hệ thống</li>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formPhanQuyen" name="formPhanQuyen" method="POST" action="admin/quyen/phanquyen/{{$quyen->q_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenQuyen"> Tên quyền hệ thống(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenQuyen" id="txtTenQuyen" class="col-xs-10 col-sm-5" placeholder="Tên quyền hệ thống" value="{{$quyen->q_ten}}" disabled="" />
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="slChucNang"> Chức năng(*): </label>
						<div class="col-xs-12 col-sm-9">
							<select multiple id="slChucNang" name="slChucNang[]" class="select2" data-placeholder="Danh sách chức năng">
								@foreach($chucnang as $cn)
									<?php $check=0; ?>
									@foreach($quyen_chucnang as $q_cn)
										@if($cn->cn_ma==$q_cn->cn_ma)
											<?php $check=1 ?>
										@endif
									@endforeach
									@if($check==1)
										<option value="{{$cn->cn_ma}}" selected="">{{$cn->cn_ten}}</option>
									@else
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="reset" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/quyen/danhsach'" >
