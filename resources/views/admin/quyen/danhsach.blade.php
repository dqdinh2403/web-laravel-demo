...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa quyền hệ thống '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="45%" class="center">Quyền hệ thống</th>
								<th width="15%" class="center">Phân quyền</th>
								<th width="15%" class="center">Cập nhật</th>
								<th width="15%" class="center">Xóa</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$q->q_ten}}</td>
								<td class="center">
								<a class="green" href="admin/quyen/phanquyen/{{$q->q_ma}}">
										<i class="ace-icon fa fa-cog bigger-130 blue"></i>
									</a>
								</td>
								<td class="center">
								<a class="green" href="admin/quyen/capnhat/{{$q->q_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/quyen/xoa/{{$q->q_ma}}" onclick="return deleteConfirm('{{$q->q_ten}}')">
