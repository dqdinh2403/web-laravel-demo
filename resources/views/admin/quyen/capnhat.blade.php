...
@section('title')
	{{"Quản lý quyền hệ thống (cập nhật)"}}
@endsection
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatQuyen" name="formCapNhatQuyen" method="POST" action="admin/quyen/capnhat/{{$quyen->q_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenQuyen"> Tên quyền hệ thống(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenQuyen" id="txtTenQuyen" class="col-xs-10 col-sm-5" placeholder="Tên quyền hệ thống" value="{{$quyen->q_ten}}" />
						</div>
					</div>
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/quyen/danhsach'" >
