...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa góp ý '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
...
@section('breadcrumb')
	<li class="active">Quản lý góp ý</li>
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="10%" class="center">Người gửi</th>
								<th width="20%" class="center">Tiêu đề</th>
								<th width="50%" class="center">Nội dung</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">
								@if($gy->tk_tendangnhap == '')
									{{"Ẩn danh"}}
								@else
									{{$gy->tk_tendangnhap}}
								@endif
								</td>
								<td class="left">{{$gy->gy_tieude}}</td>
								<td class="left">{!!$gy->gy_noidung!!}</td>
								<td class="center">
									<a class="red" href="admin/gopy/xoa/{{$gy->gy_ma}}" onclick="return deleteConfirm('{{$gy->gy_tieude}}')">
