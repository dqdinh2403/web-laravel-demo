	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiBieuMau" name="formThemMoiBieuMau" method="POST" action="admin/bieumau/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenBieuMau"> Tên biểu mẫu(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenBieuMau" id="txtTenBieuMau" class="col-xs-10 col-sm-5" placeholder="Tên biểu mẫu" value="{{old('txtTenBieuMau')}}" />
						</div>
					</div>
