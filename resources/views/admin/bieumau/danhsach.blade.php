...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa biểu mẫu '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="20%" class="center">Tên biểu mẫu</th>
								<th width="20%" class="center">Bản sao lưu</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="green" href="admin/bieumau/capnhat/{{$bm->bm_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/bieumau/xoa/{{$bm->bm_ma}}" onclick="return deleteConfirm('{{$bm->bm_ten}}')">
