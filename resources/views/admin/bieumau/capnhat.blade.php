	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatBieuMau" name="formCapNhatBieuMau" method="POST" action="admin/bieumau/capnhat/{{$bieumau->bm_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="txtTenBieuMau"> Tên biểu mẫu(*): </label>
						<div class="col-sm-10">
							<input type="text" name="txtTenBieuMau" id="txtTenBieuMau" class="col-xs-10 col-sm-5" placeholder="Tên biểu mẫu" value="{{$bieumau->bm_ten}}" />
						</div>
					</div>
					...
					<div class="form-group">   
		                ...
		                <div class="col-sm-10">
		                     <textarea name="txtNoidung" class="ckeditor">{!!$bieumau->bm_noidung!!}</textarea>
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn btn-success" name="btnPhucHoi" id="btnPhucHoi" onClick="window.location='admin/bieumau/phuchoi/{{$bieumau->bm_ma}}'"
							@if($bieumau->bm_saoluu=='')
								{{"disabled='true'"}}
							@endif
						 >
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/bieumau/danhsach'" >
							<i class="ace-icon fa fa-undo bigger-110"></i>
							Hủy
						</button>
					</div>
