...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa đối tác '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th width="20%" class="center">Đối tác</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$dt->dt_tencongty}}</td>
								<td class="left">{{$dt->dt_diachi}}</td>
								<td class="left">{{$dt->dt_dienthoai}}</td>
								<td class="left">{{$dt->dt_email}}</td>
								<td class="center">
									<a class="green" href="admin/doitac/capnhat/{{$dt->dt_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/doitac/xoa/{{$dt->dt_ma}}" onclick="return deleteConfirm('{{$dt->dt_tencongty}}')">
