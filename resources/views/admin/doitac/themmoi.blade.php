	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formThemMoiDoiTac" name="formThemMoiDoiTac" method="POST" action="admin/doitac/themmoi" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenCongTy"> Tên công ty(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenCongTy" id="txtTenCongTy" class="col-xs-10 col-sm-5" placeholder="Tên công ty" value="{{old('txtTenCongTy')}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtNguoiDaiDien" id="txtNguoiDaiDien" class="col-xs-10 col-sm-5" placeholder="Người đại diện" value="{{old('txtNguoiDaiDien')}}" />
						</div>
					</div>
