	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form id="formCapNhatDoiTac" name="formCapNhatDoiTac" method="POST" action="admin/doitac/capnhat/{{$doitac->dt_ma}}" class="form-horizontal" role="form"> 
				    {{csrf_field()}}

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="txtTenCongTy"> Tên công ty(*): </label>
						<div class="col-sm-9">
							<input type="text" name="txtTenCongTy" id="txtTenCongTy" class="col-xs-10 col-sm-5" placeholder="Tên công ty" value="{{$doitac->dt_tencongty}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtNguoiDaiDien" id="txtNguoiDaiDien" class="col-xs-10 col-sm-5" placeholder="Người đại diện" value="{{$doitac->dt_nguoidaidien}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtEmail" id="txtEmail" class="col-xs-10 col-sm-5" placeholder="Email" value="{{$doitac->dt_email}}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtDiaChi" id="txtDiaChi" class="col-xs-10 col-sm-5" placeholder="Địa chỉ" value="{{$doitac->dt_diachi}}" />
						</div>
					</div>
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="txtDienThoai" id="txtDienThoai" class="col-xs-10 col-sm-5" placeholder="Điện thoại" value="{{$doitac->dt_dienthoai}}" />
						</div>
					</div>
					...
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp; &nbsp; &nbsp;
						<button type="button" class="btn" name="btnHuy" id="btnHuy" onClick="window.location='admin/doitac/danhsach'" >
