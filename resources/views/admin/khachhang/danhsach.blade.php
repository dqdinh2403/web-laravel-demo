...
@section('javascript2')
    ...
    <script language="javascript">
		function deleteConfirm(ten){
			if(confirm("Bạn có chắc chắn muốn xóa khách hàng '" + ten + "' ?")){
				return true;	
			}
			else
				return false;
			...
			<div class="col-xs-12">
				...
				<div>
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								<th width="15%" class="center">STT</th>
								<th width="20%" class="center">Khách hàng</th>
								<th width="20%" class="center">Tài khoản</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">{{$kh->kh_tencongty}}</td>
								<td class="left">{{$kh->tk_tendangnhap}}</td>
								<td class="center">
									@if($kh->tk_trangthai==0)
								...
								<td class="center">
									<a class="green" href="admin/khachhang/capnhat/{{$kh->tk_ma}}">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
								</td>
								<td class="center">
									<a class="red" href="admin/khachhang/xoa/{{$kh->tk_ma}}" onclick="return deleteConfirm('{{$kh->kh_tencongty}}')">
