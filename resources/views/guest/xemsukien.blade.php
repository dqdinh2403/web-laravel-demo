...
<section id="content">       
  ...
  <!-- Phần giao diện xác nhận sự kiện -->
	<br /><h3>Xem nội dung sự kiện:</h3><hr />
    <form id="formXemSuKien" name="formXemSuKien" method="POST" action="" class="form-horizontal" role="form">
        {{csrf_field()}}
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
              <input type="button" class="btn btn-primary" name="btnTroVe"  id="btnTroVe" value="Trở về"
